...
(0, _tape2.default)("mix keys without keys", function (assert) {
    var leftNode = (0, _h.h)("div", [(0, _h.h)("div", { key: 1 }), (0, _h.h)("div"), (0, _h.h)("div"), (0, _h.h)("div"), (0, _h.h)("div"), (0, _h.h)("div"), (0, _h.h)("div"), (0, _h.h)("div")]);

    var rightNode = (0, _h.h)("div", [(0, _h.h)("div"), (0, _h.h)("div"), (0, _h.h)("div"), (0, _h.h)("div"), (0, _h.h)("div"), (0, _h.h)("div"), (0, _h.h)("div"), (0, _h.h)("div", { key: 1 })]);
...
(0, _tape2.default)("avoid unnecessary reordering", function (assert) {
    var leftNode = (0, _h.h)("div", [(0, _h.h)("div"), (0, _h.h)("div", { key: 1 }), (0, _h.h)("div")]);

    var rightNode = (0, _h.h)("div", [(0, _h.h)("div"), (0, _h.h)("div", { key: 1 }), (0, _h.h)("div")]);
...
(0, _tape2.default)("missing key gets replaced", function (assert) {
    ...
    var rightNode = (0, _h.h)("div", [(0, _h.h)("div"), (0, _h.h)("div"), (0, _h.h)("div"), (0, _h.h)("div"), (0, _h.h)("div"), (0, _h.h)("div"), (0, _h.h)("div"), (0, _h.h)("div")]);
...
(0, _tape2.default)("widgets can be keyed", function (assert) {
    ...
    DivWidget.prototype.init = function () {
        return (0, _createElement.createElement)((0, _h.h)("div", this.state));
    };
    ...
    var leftNode = (0, _h.h)("div", [new DivWidget("1", "a"), new DivWidget("2", "b"), new DivWidget("3", "c")]);

    var rightNode = (0, _h.h)("div", [new DivWidget("3", "c"), new DivWidget("2", "b"), new DivWidget("1", "a")]);
...
(0, _tape2.default)("delete key at the start", function (assert) {
    var leftNode = (0, _h.h)("div", [(0, _h.h)("div", { key: "a" }, "a"), (0, _h.h)("div", { key: "b" }, "b"), (0, _h.h)("div", { key: "c" }, "c")]);

    var rightNode = (0, _h.h)("div", [(0, _h.h)("div", { key: "b" }, "b"), (0, _h.h)("div", { key: "c" }, "c")]);
...
(0, _tape2.default)("add key to start", function (assert) {
    var leftNode = (0, _h.h)("div", [(0, _h.h)("div", { key: "b" }, "b"), (0, _h.h)("div", { key: "c" }, "c")]);

    var rightNode = (0, _h.h)("div", [(0, _h.h)("div", { key: "a" }, "a"), (0, _h.h)("div", { key: "b" }, "b"), (0, _h.h)("div", { key: "c" }, "c")]);
...
(0, _tape2.default)("delete key at the end", function (assert) {
    ...
    var rightNode = (0, _h.h)("div", [(0, _h.h)("div", { key: "a" }, "a"), (0, _h.h)("div", { key: "b" }, "b")]);
...
(0, _tape2.default)("add key to end", function (assert) {
    var leftNode = (0, _h.h)("div", [(0, _h.h)("div", { key: "a" }, "a"), (0, _h.h)("div", { key: "b" }, "b")]);
...
(0, _tape2.default)("add to end and delete from center & reverse", function (assert) {
    var leftNode = (0, _h.h)("div", [(0, _h.h)("div", { key: "a", id: "a" }, "a"), (0, _h.h)("div", { key: "b", id: "b" }, "b"), (0, _h.h)("div", { key: "c", id: "c" }, "c"), (0, _h.h)("div", { key: "d", id: "d" }, "d")]);

    var rightNode = (0, _h.h)("div", [(0, _h.h)("div", { key: "e", id: "e" }, "e"), (0, _h.h)("div", { key: "d", id: "d" }, "d"), (0, _h.h)("div", { key: "c", id: "c" }, "c"), (0, _h.h)("div", { key: "a", id: "a" }, "a")]);
...
(0, _tape2.default)("add to front and remove", function (assert) {
    var leftNode = (0, _h.h)("ul", [(0, _h.h)("li", { key: "c" }, "c"), (0, _h.h)("li", { key: "d" }, "d")]);

    var rightNode = (0, _h.h)("ul", [(0, _h.h)("li", { key: "a" }, "a"), (0, _h.h)("li", { key: "b" }, "b"), (0, _h.h)("li", { key: "c" }, "c"), (0, _h.h)("li", { key: "e" }, "e")]);
...
(0, _tape2.default)("adding multiple widgets", function (assert) {
    ...
    FooWidget.prototype.init = function () {
        return (0, _createElement.createElement)((0, _h.h)("div", String(this.foo)));
    };
    ...
    var secondTree = (0, _h.h)("div", [new FooWidget("foo")]);
    rootNode = (0, _patch.patch)(rootNode, (0, _diff.diff)(firstTree, secondTree));
    ...
    var thirdTree = (0, _h.h)("div", [new FooWidget("foo"), new FooWidget("bar")]);
    rootNode = (0, _patch.patch)(rootNode, (0, _diff.diff)(secondTree, thirdTree));
...
var itemHelpers = {
    item: function item(key) {
        key = key.toString();
        return (0, _h.h)('div', { key: key, id: key }, ["" + key]);
    },
...
(0, _tape2.default)('3 elements in a container, insert an element after each', function (assert) {
    ...
    var rootNode = (0, _createElement.createElement)(threeItems);
    rootNode = (0, _patch.patch)(rootNode, (0, _diff.diff)(threeItems, sixItems));
...
(0, _tape2.default)('10 elements in a container, remove every second element', function (assert) {
    ...
    var rootNode = (0, _createElement.createElement)(tenItems);
    var patches = (0, _diff.diff)(tenItems, fiveItems);
...
(0, _tape2.default)('3 elements in a container, add 3 elements after each', function (assert) {
    ...
    var rootNode = (0, _createElement.createElement)(first);
    ...
    var newRoot = (0, _patch.patch)(rootNode, (0, _diff.diff)(first, second));
...
(0, _tape2.default)('move a single element to the end', function (assert) {
    ...
    var patches = (0, _diff.diff)(start, end);
...
function keyTest(itemsA, itemsB) {
    ...
    function assertKeys(assert) {
        ...
        var patches = (0, _diff.diff)(nodesA, nodesB);

        var rootNode = (0, _createElement.createElement)(nodesA);
