...
// VirtualNode tests
ext_tape_test("Node is a function", function (assert) {
    assert.equal(typeof vnodevnode_VirtualNodejs, "function")
    assert.end()
})

ext_tape_test("Node type and version are set", function (assert) {
...
ext_tape_test("TextNode is a function", function (assert) {
    assert.equal(typeof vnodevtext_VirtualTextjs, "function")
    assert.end()
})

ext_tape_test("TextNode type and version are set", function (assert) {
...
ext_tape_test("defaults to div node", function (assert) {
    var node = h_hjs()
    assertNode(assert, node, "DIV")
    assert.end()
})

ext_tape_test("can use class selector", function (assert) {
    var node = h_hjs("div.pretty")
    assertNode(assert, node, "DIV", { className: "pretty" })
    assert.end()
})

ext_tape_test("can use non-ascii class selector", function (assert) {
    var node = h_hjs("div.ΑΒΓΔΕΖ")
    assertNode(assert, node, "DIV", { className: "ΑΒΓΔΕΖ" })
    assert.end()
})

ext_tape_test("class selectors combine with className property", function (assert) {
    var node = h_hjs("div.very", { className: "pretty" })
    assertNode(assert, node, "DIV", { className: "very pretty" })
    assert.end()
})

ext_tape_test("can use id selector", function (assert) {
    var node = h_hjs("div#important")
    assertNode(assert, node, "DIV", { id: "important" })
    assert.end()
})

ext_tape_test("can use non-ascii id selector", function (assert) {
    var node = h_hjs("div#ΑΒΓΔΕΖ")
    assertNode(assert, node, "DIV", { id: "ΑΒΓΔΕΖ" })
    assert.end()
})

ext_tape_test("properties id overrides selector id", function (assert) {
    var node = h_hjs("div#very", { id: "important" })
    assertNode(assert, node, "DIV", { id: "important" })
    assert.end()
})

ext_tape_test("defaults to div when using selectors", function (assert) {
...
ext_tape_test("second argument can be children", function (assert) {
...
ext_tape_test("third argument can be child or children", function (assert) {
...
// render tests
ext_tape_test("render is a function", function (assert) {
    assert.equal(typeof h_hjs, "function")
    assert.end()
})

ext_tape_test("render text node", function (assert) {
...
ext_tape_test("render div", function (assert) {
    var vdom = h_hjs()
    var dom = createelement_createElementjs(vdom)
    assert.notOk(dom.id)
    assert.notOk(dom.className)
...
ext_tape_test("node id is applied correctly", function (assert) {
...
ext_tape_test("node class name is applied correctly", function (assert) {
...
ext_tape_test("mixture of node/classname applied correctly", function (assert) {
...
ext_tape_test("style object is applied correctly", function (assert) {
...
ext_tape_test("children are added", function (assert) {
    var vdom = h_hjs("div", [
        h_hjs("div", [
            "just testing",
            "multiple",
...
ext_tape_test("incompatible children are ignored", function (assert) {
...
ext_tape_test("injected document object is used", function (assert) {
...
ext_tape_test("injected warning is used", function (assert) {
    var badObject = {}
    var vdom = h_hjs("#important.pretty", {
        style: {
            cssText: "color: red;"
...
ext_tape_test("textnode update test", function (assert) {
...
ext_tape_test("textnode replace test", function (assert) {
    var hello = h_hjs("div", "hello")
...
ext_tape_test("textnode insert test", function (assert) {
    var hello = h_hjs("div", "hello")
...
ext_tape_test("textnode remove", function (assert) {
    var again = h_hjs("span", ["hello", "again"])
    var hello = h_hjs("div", "hello")
...
ext_tape_test("dom node update test", function (assert) {
...
ext_tape_test("dom node replace test", function (assert) {
    var hello = h_hjs("div", "hello")
...
ext_tape_test("dom node insert", function (assert) {
...
ext_tape_test("dom node remove", function (assert) {
    var hello = h_hjs("div", [h_hjs("span", "hello")])
    var again = h_hjs("div", [h_hjs("span", "hello"), h_hjs("span", "again")])
    var rootNode = createelement_createElementjs(again)
    var equalNode = createelement_createElementjs(hello)
...
ext_tape_test("reuse dom node without breaking", function (assert) {
...
ext_tape_test("Allow empty textnode", function (assert) {
...
ext_tape_test("Can replace vnode with vtext", function (assert) {
...
// Widget tests
ext_tape_test("Widget is initialised on render", function (assert) {
    var initCount = 0
...
ext_tape_test("Nested widget is initialised on render", function (assert) {
    var initCount = 0
    var testNode = createelement_createElementjs(h_hjs("div"))
    var Widget = {
        init: function () {
...
ext_tape_test("Patch widgets at the root", function (assert) {
    var initCount = 0
    var updateCount = 0
    var leftState = { a: 1 }
    var rightState = { a: 2 }
...
ext_tape_test("Patch nested widgets", function (assert) {
    var initCount = 0
    var updateCount = 0
    var leftState = { a: 1 }
    var rightState = { a: 2 }
...
ext_tape_test("Can replace stateful widget with vnode", function (assert) {
    var statefulWidget  = {
        init: function () {
...
ext_tape_test("Can replace vnode with stateful widget with vnode", function (assert) {
    var statefulWidget  = {
        init: function () {
            return createelement_createElementjs(h_hjs("div.widget"));
        },
...
ext_tape_test("Ensure children are not rendered more than once", function (assert) {
    var initCount = 0
    var updateCount = 0
    var rightState = { a: 1 }
    var domNode
...
ext_tape_test("VNode indicates stateful sibling", function (assert) {
    var statefulWidget  = {
        init: function () {},
        update: function () {},
        destroy: function () {},
...
ext_tape_test("Replacing stateful widget with vnode calls destroy", function (assert) {
    var count = 0
    var statefulWidget  = {
        init: function () {},
        update: function () {},
...
ext_tape_test("Replacing stateful widget with stateful widget", function (assert) {
    var count = 0
    var statefulWidget  = {
        init: function () {},
        update: function () {},
...
ext_tape_test("Replacing stateful widget with pure widget", function (assert) {
    var count = 0
    var statefulWidget  = {
        init: function () {},
        update: function () {},
...
ext_tape_test("Removing stateful widget calls destroy", function (assert) {
    var count = 0
    var statefulWidget  = {
        init: function () {},
        update: function () {},
...
ext_tape_test("Patching parent destroys stateful sibling", function (assert) {
    var count = 0
...
ext_tape_test("Widget update can replace domNode", function (assert) {
...
ext_tape_test("Destroy widget nested in removed thunk", function (assert) {
    var count = 0
...
ext_tape_test("Create element respects namespace", function (assert) {
...
ext_tape_test("Different namespaces creates a patch", function (assert) {
    if (!supportsNamespace()) {
        assert.skip("browser doesn't support namespaces");
        return assert.end();
    }
